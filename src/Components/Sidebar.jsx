  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 z-10 p-6 flex flex-col items-center bg-gradient-to-r from-white to-blue-50/80 backdrop-blur-xl border-b border-blue-100/60">
        ...
        <span
          className={`font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-cyan-600 text-xl ${
          ...
          {elements.map((item, idx) => {
            ...
            return (
              <div key={idx} className="relative">
                {/* Main Menu Item */}
                <div
                  className={`flex items-center py-3 px-4 rounded-2xl transition-all duration-300 cursor-pointer group ${
                ...
                {isDropdownOpen && hasDropdown && !isCollapsed && (
                  <div className="ml-12 mt-2 space-y-1.5 animate-fadeIn">
                    {item.dropdown.map((subItem, subIdx) => (
                      <div
                        key={subIdx}
                        className={`flex items-center py-2.5 px-4 rounded-xl transition-all duration-300 cursor-pointer ${
                      ...
                      >
                        ...
                        {subItem.path ? (
                          ...
                          <div
                            className={`flex-1 flex items-center font-medium cursor-pointer transition-all duration-300 ${
                              "text-slate-600 hover:text-blue-700"
                            }`}
                            style={{ textDecoration: "none" }}
